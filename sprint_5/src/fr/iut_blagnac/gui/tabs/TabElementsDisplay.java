...
public class TabElementsDisplay extends JPanel implements ItemListener{
	...
	public TabElementsDisplay(JFrame currentApplication, DataManager currentDataManager){
...
// !!-------------------------------------------------------------------------------------------------
			// J'ai pas mieux pour actualiser les groupes, et j'en ai besoin donc (très mauvaise) solution temporaire
